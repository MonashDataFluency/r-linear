...
<div style="float: right">
```{r echo=F,fig.width=2,fig.height=2,animation.hook="gifski", interval=0.1}
for(t in 1:40) {
    par(mar=c(0,0,0,0))
    plot(0,type='n',axes=FALSE,ann=FALSE, 
         xlim=c(2,6), ylim=c(2,6), asp=1)
...
We want to specify the model on a transformed scale even if the data contains values that can't be transformed.
...
With a **random effect**, the levels of a factor as represent individuals from some large population. 
