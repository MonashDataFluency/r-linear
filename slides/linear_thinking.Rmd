...
>* calculation of averages and correlations
...
Much of the design of the S language (predecessor to R) exists to support linear models and their generalizations:
...
>* predicted response for an individual
>* difference in predicted response between two individuals

Constraining a contrast to be zero is another way to specify a null hypothesis.

We might want:

>* estimated value of the contrast (calculated with dot product)
...
>* Generalized Least Squares<br>(account for covariance in noise)
>* Mixed models<br>(some coefficients are drawn from a random distribution)
