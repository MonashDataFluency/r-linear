...
>* a **contrast** compares specific levels of an experimental factor<span class="tip">*<span class="tiptext">Terminology is a little tricky here. The limma package we are using later refers to linear combinations in general as contrasts.</span></span>
