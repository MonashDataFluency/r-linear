...
**... is a bunch of dot products.** Taking the product of a matrix $X$ and a vector $a$ with length matching the number of columns, the result is a vector containing the dot product of each row of the matrix $X$ with the vector $a$.
...
**... is a weighted sum of columns.** Can also think of this as a weighted sum of the columns of $X$.
