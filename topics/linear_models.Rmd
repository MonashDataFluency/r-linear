...
Return to the `people` dataset. What is the 95% confidence interval on the slope, in cm per year? Can we reject the hypothesis that height is unrelated to age?
...
The ratio of fold changes per day between the upper and lower molars is confidently within 2^-0.22 to 2^0.19 (0.86 to 1.14).
