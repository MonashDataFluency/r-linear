...
The `logFC` column contains the estimate for the quantity we are interested in. Usually this is a log fold change, hence the column name, but in this case it is a slope.
...
Confidence Intervals may also be of interest. However note that these are not adjusted for multiple testing (see Appendix B).
