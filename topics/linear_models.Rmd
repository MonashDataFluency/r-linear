...
3. Construct a pair of contrasts that when used together in an F test find genes with non-zero slope in either or both the lower or upper molars.
...
The total effective degrees of freedom is the "prior" degrees of freedom plus the normal residual degrees of freedom. As can be seen in the plot, this produces a posterior residual variance (`efit$s2.post`) that is squeezed toward the trend line.
