...
We use new `( | )` notation to specify random effects. Right of the `|` you give the factor specifying individuals from a population. Left of the `|` you give predictors whose coefficients may vary between individuals. In the example above we are saying the the intercept may vary between individuals.
