...
The [emmeans](https://cran.r-project.org/web/packages/emmeans/index.html) package also automates many common comparisons. In particualar if you are working with models including interactions this package knows to average over interactions when examining main effects.
